...
public class GiftCharge {
    ...
    public GiftCharge capture(Map<String, Object> transactionParams) throws IOException {
        ...
        return new GiftCharge(APICore.finalizeTransaction(getCardId(), getTransactionId(), "capture", transactionParams));
    }
    ...
    public GiftCharge cancel (Map<String, Object> transactionParams) throws IOException {
        ...
        return new GiftCharge(APICore.finalizeTransaction(getCardId(), getTransactionId(), "void", transactionParams));
    }
