...
import com.lightrail.old.model.api.objects.Metadata;
import com.lightrail.old.model.api.objects.RequestParameters;
import com.lightrail.old.model.api.objects.Transaction;
...
public class LightrailTransaction extends Transaction {
    ...
    public static final class Create {
        ...
        public static LightrailTransaction pendingByShopperId(String shopperId, int value, String currency) throws AuthorizationException, CouldNotFindObjectException, InsufficientValueException, IOException {
            return pendingByShopperId(shopperId, value, currency, null);
        }

        public static LightrailTransaction pendingByShopperId(String shopperId, int value, String currency, Metadata metadata) throws AuthorizationException, CouldNotFindObjectException, InsufficientValueException, IOException {
            return byShopperId(shopperId, value, currency, true, metadata);
        }

        public static LightrailTransaction byShopperId(String shopperId, int value, String currency) throws AuthorizationException, CouldNotFindObjectException, InsufficientValueException, IOException {
            return byShopperId(shopperId, value, currency, null);
        }

        public static LightrailTransaction byShopperId(String shopperId, int value, String currency, Metadata metadata) throws AuthorizationException, CouldNotFindObjectException, InsufficientValueException, IOException {
            return byShopperId(shopperId, value, currency, false, metadata);
        }
        ...
        private static LightrailTransaction byShopperId(String shopperId, int value, String currency, boolean pending, Metadata metadata) throws AuthorizationException, CouldNotFindObjectException, InsufficientValueException, IOException {
            RequestParameters transactionParams = new RequestParameters();
            transactionParams.put(LightrailConstants.Parameters.SHOPPER_ID, shopperId);
            transactionParams.put(LightrailConstants.Parameters.VALUE, value);
            transactionParams.put(LightrailConstants.Parameters.CURRENCY, currency);
            transactionParams.put(LightrailConstants.Parameters.PENDING, pending);
            if (metadata != null && !metadata.isEmpty())
        ...
        private static LightrailTransaction create(RequestParameters transactionParams, boolean simulate) throws IOException, InsufficientValueException, AuthorizationException, CouldNotFindObjectException {
            ...
            if (code != null && !code.isEmpty()) {
                if (simulate) {
                    transaction = new LightrailTransaction(APICore.Transactions.simulateByCode(code, transactionParams));
                } else {
                    transaction = new LightrailTransaction(APICore.Transactions.createByCode(code, transactionParams));
                }
            } else if (cardId != null && !cardId.isEmpty()) {
                if (simulate) {
                    transaction = new LightrailTransaction(APICore.Transactions.simulateByCardId(cardId, transactionParams));
                } else {
                    transaction = new LightrailTransaction(APICore.Transactions.createByCardId(cardId, transactionParams));
                }
            } else
    ...
    public static final class Retrieve {
        ...
        public static LightrailTransaction byCardIdAndUserSuppliedId(String cardId, String userSuppliedId) throws AuthorizationException, IOException, InsufficientValueException, CouldNotFindObjectException {
            return new LightrailTransaction(APICore.Transactions.retrieveByCardIdAndUserSuppliedId(cardId, userSuppliedId));
        }
        ...
        public static LightrailTransaction byCardIdAndTransactionId(String cardId, String transactionId) throws AuthorizationException, IOException, InsufficientValueException, CouldNotFindObjectException {
            return new LightrailTransaction(APICore.Transactions.retrieveByCardIdAndTransactionId(cardId, transactionId));
        }
        ...
        public static LightrailTransaction byCodeAndUserSuppliedId(String code, String userSuppliedId) throws AuthorizationException, IOException, InsufficientValueException, CouldNotFindObjectException {
            return new LightrailTransaction(APICore.Transactions.retrieveByCodeAndUserSuppliedId(code, userSuppliedId));
        }
        ...
        public static LightrailTransaction byCodeAndTransactionId(String code, String transactionId) throws AuthorizationException, IOException, InsufficientValueException, CouldNotFindObjectException {
            return new LightrailTransaction(APICore.Transactions.retrieveByCodeAndTransactionId(code, transactionId));
        }
    }
